        ...
        for i in range(int(msg[0])):
            ...
            if "Available" in isav:
                ...
                try:
                    ...
                    await sython.send_file(event.chat_id, 'https://t.me/yyyyyy3w/7', caption=f'''Leader : @AbnBashar
...
''')
    ...
    {str(eee)}''')
        ...
        isclaim.append("off")
        trys = ""
        await event.client.send_message(event.chat_id, "Sorry but «Fury™» number 1 🥇")
